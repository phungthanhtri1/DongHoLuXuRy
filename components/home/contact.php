            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                        ...
                        <p class="mb-5 fs-5 text-dark">We’re here to help with any questions about our watches, orders, repairs or returns.</p>
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <p class="mb-4 wow fadeInUp" data-wow-delay="0.5s">If you need assistance with a watch, order or warranty, send us a message and our support team will respond shortly.</p>
                    <form>
                    ...
                    <div class="row g-4 align-items-center justify-content-center">
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="rounded p-4">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">123 Watch Street, New York, USA</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="rounded p-4">
                                ...
                                <div>
                                    <h4>Email</h4>
                                    <p class="mb-2">support@yourwatchstore.com</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                            <div class="rounded p-4">
                                ...
                                <div>
                                    <h4>Website</h4>
                                    <p class="mb-2">www.yourwatchstore.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
