		...
		<div class="row g-4">
			<div class="col-lg-5 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
				...
				<div class="featured-product mb-4">
					...
					<div class="featured-product-item">
						...
						<div>
							<h6 class="mb-2">Classic Chronograph</h6>
							<div class="d-flex mb-2">
								<h5 class="fw-bold me-2">$1,499.00</h5>
								<h5 class="text-danger text-decoration-line-through">$1,799.00</h5>
							</div>
						</div>
					</div>
					<div class="featured-product-item">
						...
						<div>
							<h6 class="mb-2">Sport Diver</h6>
							<div class="d-flex mb-2">
								<h5 class="fw-bold me-2">$1,199.00</h5>
								<h5 class="text-danger text-decoration-line-through">$1,399.00</h5>
							</div>
						</div>
					</div>
					<div class="featured-product-item">
			...
			<div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
				<div class="row g-4 single-product">
					...
					<div class="col-xl-6">
						<h4 class="fw-bold mb-3">Luxury Watch</h4>
						<p class="mb-3">Category: Watches</p>
						<h5 class="fw-bold mb-3">$2,999.00</h5>
						...
						<!-- product purchase action: add to cart -->
						<a href="cart.php" class="btn btn-primary border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class="fa fa-shopping-bag me-2 text-white"></i> Add to cart</a>
						<!-- if you prefer to pass model: href="cart.php?add=LX-2025" -->
					</div>
					<div class="col-lg-12">
						<nav>
