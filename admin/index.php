...
$titles = [
    ...
    'danhmuc' => 'Quản lý Danh mục',     // Mới thêm
    'adddm' => 'Thêm danh mục',          // Mới thêm
    'editdm' => 'Sửa danh mục'           // Mới thêm
];
    ...
    <div id="content">
        <div class="main-header">
            ...
            <div class="user-info d-flex align-items-center gap-2">
                <div class="text-end lh-1"><span class="d-block fw-bold text-dark small">Admin</span><small class="text-success" style="font-size: 0.7rem;">● Online</small></div>
